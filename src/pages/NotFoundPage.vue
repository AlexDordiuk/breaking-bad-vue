<template>
  <v-container fluid class="d-flex align-center justify-center mx-auto" style="height: 100%">
  <svg id="404-Dave" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 250">
    ...
    <g id="bg">
      <path id="Bg-green" fill="#00796B" d="M275.7 207c-46.5 0-84.3-37.8-84.3-84.3s37.8-84.3 84.3-84.3S360 76.2 360 122.7 322.2 207 275.7 207z"/>
    ...
    <g id="Dave-clipper" clip-path="url(#center-circle-clip)">
      <g id="Dave">
        ...
        <g id="Neck">
          <path id="Neck-fill" fill="#FFECB3" d="M275.5 157c-8 0-14.5 6.5-14.5 14.5v15c0 8 6.5 14.5 14.5 14.5s14.5-6.5 14.5-14.5v-15c0-8-6.5-14.5-14.5-14.5z"/>
          ...
          <path fill="#FFCC80" d="M262.1 187.7c4.5 1.3 9.3 1.9 14.4 1.7 4.4-.1 8.6-.8 12.5-2v-1.3l-.1-3.7c-4 1.2-8.2 1.9-12.6 2.1-5.1.2-9.9-.5-14.4-1.7l.1 4.2c0 .2.1.5.1.7z" id="Neck-Innershadow"/>
        </g>
        <g id="Ears">
          <g id="Ear-right">
            <path id="Ear-fill-right" fill="#FFECB3" d="M314.8 130.2c-5.5 0-9.9-4.4-9.9-9.9s4.4-9.9 9.9-9.9 9.9 4.4 9.9 9.9-4.5 9.9-9.9 9.9z"/>
          ...
          <g id="Ear-left">
            <path id="Ear-fill-left" fill="#FFECB3" d="M234.8 130.2c-5.5 0-9.9-4.4-9.9-9.9s4.4-9.9 9.9-9.9 9.9 4.4 9.9 9.9-4.5 9.9-9.9 9.9z"/>
        ...
        <g id="Face">
          <path id="Face-fill" fill="#FFECB3" d="M275 172c-22.6 0-41-18.3-41-40.9v-28.7c0-22.6 18.4-40.9 41-40.9s41 18.3 41 40.9v28.7c0 22.6-18.4 40.9-41 40.9z"/>
          ...
          <path id="Face-innershadow" fill="#FFCC80" d="M274.6 62.5c-2.2 0-4.2.2-6.3.5 19 3.1 33.7 19.5 33.7 39.4v28.7c0 19.8-15 36.3-33.9 39.4 2.1.3 4.5.5 6.7.5 22 0 40.2-17.9 40.2-39.9v-28.7c0-22-18.4-39.9-40.4-39.9z"/>
          <g id="Blush" fill="#FFB74D
">
